...
public class ClientForm extends javax.swing.JFrame {
    ...
    private void ConnectToServer() {
        ...
        try {
            ...
            Log.TagToLog("Connecting to server successful!", jTextArea1, MY_NAME);
            IsConnected = true;
        } catch (IOException ex) {
            cs = null;
    ...
    private void DisconnectFromServer() {
        ...
        if(SR.SendCommand("DG") == SEND_FAILED) {
            Log.TagToLog("Bad command. Try again", jTextArea1, MY_NAME);
        } else {
            IsConnected = false;
            if(RT != null) {
                RT.stop();
            }
            Log.TagToLog("Client disconnected from server!", jTextArea1, MY_NAME);
        }
    }
    ...
    private void JoinToGameActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_JoinToGameActionPerformed
        if(!IsConnected) {
            ...
            Log.TagToLog("Game already runnung!", jTextArea1, MY_NAME);
        }
    ...
    private void ExitFromGameActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ExitFromGameActionPerformed
        if(IsConnected) {
            ...
            Log.TagToLog("Connection is not established. Refused in exit!", jTextArea1, MY_NAME);
        }
    ...
    private void CreateNewGameActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_CreateNewGameActionPerformed
        if (!IsConnected) {
            ...
            Log.TagToLog("Game already running!", jTextArea1, MY_NAME);
        }
    ...
    private void ClickOnCellMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_ClickOnCellMouseClicked
        if (IsConnected) {
            ...
            if (TurnPermit.MoveIsPermit) {
                ...
                Log.TagToLog("Please, wait your opponent!", jTextArea1, MY_NAME);
            }
        } else {
            Log.TagToLog("Please, create or join to existing game!", jTextArea1, MY_NAME);
        }
